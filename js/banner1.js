$(function(){
	...
	function boxanimate(){
		...
		if(i>boxleng-1){i=0}		
		boxli2.addClass("cur2");
		setTimeout(function(){
			boxli2.removeClass("cur2");
			boxli2.removeClass("cur2").eq(i).addClass("cur2");
			boxli2.stop().animate({opacity:0,"z-index":"1"},500).eq(i).stop().animate({opacity:1,"z-index":boxleng},500);
			bannerdot(i)
		},400)	
	}
